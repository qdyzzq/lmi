...
<body class="bg-slate-100 flex h-screen overflow-hidden">
    <aside class="w-72 bg-[#1e3a8a] text-white flex flex-col shadow-xl z-10">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-auto">
            ...
            <a href="{{ route('Skill.Gap.Demand') }}" class="flex items-center gap-3 p-3 text-blue-100 hover:bg-blue-800 rounded-lg transition group">
             ...
             <a href="{{ route('Job.Market.Overview') }}" class="flex items-center gap-3 p-3  bg-yellow-400 text-blue-900 font-bold  rounded-lg transition shadow-md">
    ...
    <div class="max-w-4xl mx-auto bg-white rounded-xl shadow p-8">
        ...
        <div class="mt-8 flex justify-end gap-3">
            <button id="resetBtn" class="px-6 py-2 rounded-lg border border-slate-300 text-slate-600 hover:bg-slate-100">
                Reset
            </button>
            <button id="saveBtn" class="px-6 py-2 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 shadow">
                Save Data
            </button>
        </div>
    </div>
