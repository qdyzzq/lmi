...
<body class="bg-slate-100 flex h-screen overflow-hidden" >
    ...
    <script>
        window.AppRoutes = {
            jobTitlesStore:     "{{ route('admin.job-titles.store') }}",
            jobTitlesCheckYear: "{{ route('admin.job-titles.check-year') }}",
            jobTitlesHistory:   "{{ route('admin.job-titles.history') }}"
        };
    </script>
    @vite('resources/js/admin/Module2/job-title-form.js')
