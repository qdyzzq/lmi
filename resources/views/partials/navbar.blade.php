    ...
    <div class="max-w-7xl mx-auto px-6 py-4 ">
        <div class="flex items-center justify-between">
            ...
            <div class="hidden xl:flex items-center gap-6">
                ...
                <a href="{{ route('program.stories') }}"
                    class="px-6 py-3.5 rounded-lg text-sm font-medium transition-all duration-200 
                          {{ request()->routeIs('program.stories')
                              ? 'bg-white/30 text-white shadow-lg backdrop-blur-sm'
                              : 'text-white hover:bg-white/20 hover:text-white' }}">
                    <div class="flex items-center gap-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
...
=======
    <div class="max-w-7xl mx-auto px-6 transition-all duration-300" :class="isScrolled ? 'py-2' : 'py-4'">
        <div class="flex items-center justify-between gap-4">
            ...
            <!-- Logo & Brand — fixed min-width so it never squishes the links -->
            <div class="flex items-center shrink-0 transition-all duration-300" :class="isScrolled ? 'gap-2' : 'gap-4'">
                <div class="flex items-center justify-center shrink-0 overflow-hidden bg-white rounded-full shadow-lg ring-2 ring-white/20 transition-all duration-300"
                    :class="isScrolled ? 'w-9 h-9' : 'w-14 h-14'">
                    <img src="{{ asset('images/dole_logo.png') }}" alt="LMI Logo" class="w-full h-full object-contain p-1">
                </div>
            ...
            <!-- Navigation Links — whitespace-nowrap prevents wrapping during transition -->
            <div class="hidden xl:flex items-center shrink-0 transition-all duration-300"
