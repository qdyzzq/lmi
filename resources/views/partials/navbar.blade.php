    ...
    <div class="max-w-7xl mx-auto px-6 transition-all duration-300" :class="isScrolled ? 'py-2' : 'py-4'">
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex items-center shrink-0 transition-all duration-300" :class="isScrolled ? 'gap-2' : 'gap-4'">
                ...
                {{--
                    FIX: Static w-14 h-14 hardcoded so the container has a size BEFORE
                    Alpine.js initializes — prevents the large logo flash on tab switch.
                --}}
            ...
            <!-- Navigation Links -->
            {{--
                FIX: All SVGs now have static w-5 h-5 in their class attribute as the
                default size. Alpine :class still overrides to w-3.5 h-3.5 when scrolled,
