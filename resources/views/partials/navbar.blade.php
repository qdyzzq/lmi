<nav x-data="{
    ...
    <div class="flex items-center justify-between gap-4">
        ...
        <div class="flex items-center shrink-0 gap-2 xl:gap-4 transition-all duration-300"
            ...
            <div class="leading-tight overflow-hidden min-w-0">
                <p class="font-bold text-white tracking-tight transition-all duration-300 text-sm xl:text-lg truncate"
                    :class="{ 'xl:!text-sm': isScrolled, 'xl:!text-lg': !isScrolled }">Davao Region Labor Market
                    Information</p>
        ...
        <button
            ...
            @click.stop="mobileMenuOpen = !mobileMenuOpen" :aria-expanded="mobileMenuOpen" aria-label="Toggle menu">
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200"
        ...
        :style="'top: ' + $el.closest('nav').offsetHeight + 'px'" style="display: none;">
        <div class="px-6 py-4 space-y-2">
            <a href="{{ route('Public.Module1.home') }}" @click="mobileMenuOpen = false"
            ...
            <a href="{{ route('Public.Module2.Job.Market.Demands') }}" @click="mobileMenuOpen = false"
            ...
            <a href="{{ route('Public.Module3.supply.side') }}" @click="mobileMenuOpen = false"
            ...
            <a href="{{ route('Public.Module4.programStories') }}" @click="mobileMenuOpen = false"
            ...
            <a href="{{ route('Public.Module5.peso.directory') }}" @click="mobileMenuOpen = false"
            ...
            <a href="{{ route('Public.Module6.publication') }}" @click="mobileMenuOpen = false"
                class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium {{ request()->routeIs('Public.Module6.publication') ? 'bg-white/20 text-white' : 'text-slate-200 hover:bg-white/10' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"
                    class="w-5 h-5 shrink-0">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
