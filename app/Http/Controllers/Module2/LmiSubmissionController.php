...
use App\Models\Module2\LmiHardToFillRole;
use App\Models\Module2\LmiDiagnosis;
use App\Models\Module2\LmiEngagement;
...
{   
    ...
    public function adminIndex(Request $request)
    {
        ...
        return view('admin.Module2.LmiSubmissions', compact(
            'submissions', 
            'pendingCount', 
            'approvedCount', 
            'rejectedCount'
