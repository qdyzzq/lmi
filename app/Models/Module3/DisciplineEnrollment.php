...
class DisciplineEnrollment extends Model
{
    use HasFactory;
    ...
    /**
     * Get the user who submitted this enrollment data
     */
    ...
    public function getDisciplinesArray(): array
    {
        return [
            ...
            'Home Economics' => $this->home_economics,
            ...
            'Other Disciplines' => $this->other_disciplines,
