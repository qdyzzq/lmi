...
return new class extends Migration
{
    ...
    {
        Schema::create('discipline_graduates', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['academic_year', 'province', 'institution_type'], 'unique_graduate_record');
        });
    }
    ...
    {
        Schema::dropIfExists('discipline_graduates');
    }
};