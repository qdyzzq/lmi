...
class ProgramSeeder extends Seeder
{
    ...
    [
        ...
        'image_path'    => 'images/testimonials/GIP.webp',
        'program_label' => 'GIP',
    ...
    [
        ...
        'image_path'    => 'images/testimonials/jobstart.webp',
    ...
    [
        ...
        'image_path'    => 'images/testimonials/spes.webp',
        'program_label' => 'SPES',
        'sort_order'    => 3,
        'is_active'     => 1,
        'created_at'    => now(),
    ...
    [
        ...
        'image_path'    => 'images/testimonials/CDSP.webp',
        'program_label' => 'CDSP',
        ...
        ProgramQualification::insert([
            ['program_id' => $cdsp->id, 'type' => 'beneficiarie', 'content' => 'Jobseekers',              'sort_order' => 1],
            ['program_id' => $cdsp->id, 'type' => 'beneficiarie', 'content' => 'Employers',               'sort_order' => 2],
            ['program_id' => $cdsp->id, 'type' => 'beneficiarie', 'content' => 'Students & Youth',        'sort_order' => 3],
            ['program_id' => $cdsp->id, 'type' => 'beneficiarie', 'content' => 'Migrant Workers',         'sort_order' => 4],
            ['program_id' => $cdsp->id, 'type' => 'beneficiarie', 'content' => 'Long-term Unemployed',    'sort_order' => 5],
            ['program_id' => $cdsp->id, 'type' => 'beneficiarie', 'content' => 'Persons with Disabilities', 'sort_order' => 6],
