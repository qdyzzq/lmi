    ...
    public function run(): void
    {
        $records = [
            ...
            [
                ...
                'analysis_text' => "Higher education enrollment across Davao Region for the 2021–2022 academic year was primarily driven by two dominant disciplines: Business Administration (29.9%) and Education Science (22.2%). Together, these sectors represented over half of the region's total student population, highlighting a significant focus on professional service and academic career paths. This core was supported by a strong interest in Medical and Allied fields, which captured a 12.6% market share, while Engineering and Technology maintained a notable presence at 8.3%.\n\nThe remaining enrollment was distributed among several secondary and specialized disciplines, led by Criminal Justice Education (5.8%) and IT-Related Disciplines (4.3%). While the region showed diverse academic participation in areas such as Agriculture (2.3%), Social Sciences (2.3%), and Natural Sciences (2.3%), these individual fields remained small relative to the leading professional tracks. Highly specialized programs, including Mathematics (0.3%) and Fine Arts (0.2%), represented the smallest segments of the regional student body, with Home Economics and General Programs reporting 0.0% enrollment. Overall, the 2021–2022 data reflects a regional workforce supply heavily weighted toward business, education, and healthcare, with a broad but thinly populated array of technical and scientific programs.",
                'is_active'     => 1,
                'status'        => 'published',
            ],
            [
            ...
            [
                ...
                'analysis_text' => "The academic landscape of Davao Region for the 2024–2025 academic year is characterized by a continued and substantial focus on professional service and healthcare sectors. Business Administration remains the most sought-after discipline, capturing 29.3% of the total enrollment, followed by Education Science at 16.5%. When combined with Medical and Allied fields, which hold a 12.1% share, these three disciplines account for nearly 58% of the region's higher education population.\n\nThis distribution reflects a stable workforce pipeline aimed at administrative, academic, and medical careers. Supporting this core are several robust secondary fields:\n\n- Criminal Justice Education (9.9%) and Engineering and Technology (8.0%) maintain significant roles in the regional educational output.\n- IT-Related Disciplines (6.4%) and Service Trades (3.8%) show healthy participation, aligning with the region's technological and service-based economic needs.\n- Specialized sectors such as Agriculture (2.7%), Maritime (2.4%), and Social Sciences (1.7%) contribute to a more diversified talent pool.\n\nDespite the overall diversity of offerings, foundational and niche programs represent the smallest segments of the student body. Natural Science (1.2%), Mathematics (0.3%), and Fine Arts (0.1%) continue to see minimal enrollment levels. These trends suggest that while Davao Region is a powerhouse for professional and medical training, there is an ongoing opportunity to bolster interest in the basic sciences and creative industries to ensure long-term regional innovation.",
                'is_active'     => 1,
                'status'        => 'published',
            ],
        ];
